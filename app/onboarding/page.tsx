...
const STEPS = ["Business Info", "Learn Your Site", "Availability", "Services", "Get Your Widget"];
          ...
          {step === 3 && (
            <div>
              ...
              <div className="flex gap-3 mt-6">
                <button onClick={() => { setStep(4); fetchBusinessId(); }} className="py-3 px-5 rounded-xl font-bold text-sm border"
                  style={{ border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.4)", background: "transparent" }}>
                  Skip
                </button>
